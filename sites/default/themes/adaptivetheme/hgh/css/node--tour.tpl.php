  ...
  <div<?php print $content_attributes; ?>>
    ...
    */
    ...
    <div class="tour-content">
		<div class="tabs">
			<div class="text tab-selected" id="overview-tab-content"><?php print t('Overview');?></div>
	...
	if ($similar_tour || $last_viewed) {
		...
		if ($last_viewed) {
			if ($similar_tour) print '<div class="text" id="last-viewed-content">'.t('Last Viewed').'</div>';
			else print '<div class="text tab-selected" id="last-viewed-content">'.t('Last Viewed').'</div>';
		}
