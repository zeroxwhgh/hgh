...
jQuery(document).ready(function() {
	...
	if (Drupal.settings.hgh_travel.nid > 0) {
		try {
			...
			script.src = 'https://maps.googleapis.com/maps/api/js?sensor=false&callback=gmap_initialize';
...
function gmap_initialize() {
	jQuery('.showmap').click(function() {
		showmap();
		jQuery('html,body').animate({scrollTop: jQuery("#images-slider").offset().top - 100}, 'slow');	
	});
